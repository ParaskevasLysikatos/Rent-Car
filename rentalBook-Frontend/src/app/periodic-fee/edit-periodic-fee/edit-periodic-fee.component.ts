...
@Component({
  selector: 'app-edit-periodic-fee',
  templateUrl: './edit-periodic-fee.component.html',
  styleUrls: ['./edit-periodic-fee.component.scss'],
  providers: [{provide: ApiService, useClass: PeriodicFeeService}]
})
export class EditPeriodicFeeComponent extends EditFormComponent<IPeriodicFee> {
