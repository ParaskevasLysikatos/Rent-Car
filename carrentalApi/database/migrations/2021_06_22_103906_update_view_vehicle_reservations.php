...
class UpdateViewVehicleReservations extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::statement(
            ...
            AND rentals.status NOT IN ('closed', 'cancelled', 'check-in', 'pre-check')
            UNION ALL
            (
                SELECT
                'transition' AS `type`,
    ...
    public function down()
    {
        ...
        DB::statement(
            ...
            AND rentals.status NOT IN ('completed', 'cancelled', 'checkin', 'pre-checked-in')
            UNION ALL
            (
                SELECT
                'transition' AS `type`,
