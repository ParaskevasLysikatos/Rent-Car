...
class QuoteFilter extends ReservationFilter
{
    protected $extra_filters = [
        'sequence_number' => LikeFilter::class,
        'group' => 'group_filter',
        'duration' => LikeFilter::class,
        'cancel_reason_id' => 'cancel_reason_filter',

        'payer' => 'payer_filter',
        'phone' => 'phone_filter',

        'checkin_place_id'=>InFilter::class,
    ...
    public function cancel_reason_filter($builder, $filter, $value){
        $builder = $builder->where('cancel_reason_id', '=', $value);
    }
