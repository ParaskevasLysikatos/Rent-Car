...
<head>
    ...
    <style>
        ...
        .title-like {
            background: {{ $colors->primary_background_color ?? '#D8D8D8' }} !important;
            color: {{ $colors->primary_text_color ?? '#212E74' }} !important;
        ...
        .summary-table {
            border: 0.3px solid {{ $colors->placeholder_text_color ?? '#212E74' }};
        }
        ...
        .summary-table td, .summary-table th {
            border: 0.3px solid {{ $colors->placeholder_text_color ?? '#212E74' }} !important;
        ...
        td.bordered {
            border: 1px solid {{ $colors->placeholder_text_color ?? '#212E74' }} !important;
        }
                                    ...
                                    <tr class="headings">
                                        <td class="center" width="50%">
                                            @if($model->type == 'invoice')
                                                <span class="title d-block" style="margin-right: 5px">{{__('INVOICE / ΤΙΜΟΛΟΓΙΟ')}}</span>
                                            @else
                                                <span class="title d-block" style="margin-right: 5px">{{__('RECEIPT / ΑΠΟΔΕΙΞΗ')}}</span>
                                            @endif
                                        </td>
                                        <td width="32%" class="center heading"><span style="height: 20px !important; line-height: 13px; margin-right: 5px; margin-left: 5px;text-transform: none !important;" class="d-block-inline heading title-like">Date / Ημερομηνια {{ formatDate($model->created_at) }}</span></td>
                                        <td class="center heading vertical-middle"><span style="height: 20px !important; line-height: 13px;" class="d-block-inline heading title-like">{{ $model->sequence_number }}</span></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                            ...
                                            <td class="table-td">
                                                <table>
                                                    <tbody>
                                                                ...
                                                                <table>
                                                                    <tr class="input-box">
                                                                        <td width="50%">
                                                                            ...
                                                                            <span class="bold">{{ $model->instance->occupation }}</span>
                                                                        </td>
                                                                        <td>
                                                                            <span class="sub-title">Tax Id / Α.Φ.Μ.</span>
                                                                            <span class="bold">{{$model->instance->afm}}</span>
                                                                        </td>
                                                                        <td>
                                                                            <span class="sub-title">Tax Office / Δ.Ο.Y.</span>
                                                                            <span class="bold">{{$model->instance->doy}}</span>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        ...
                                                        <tr class="input-box">
                                                            <td colspan="4">
                                                                <span class="sub-title">Drivers Full Name / Ονοματεπώνυμο οδηγού</span>
                                                                <span class="bold">{{$model->instance->driver}}</span>
                                                            </td>
                                                        </tr>
                                                        <tr class="input-box">
                                                            <td>
                                        ...
                                        <tr class="input-box">
                                            <td>
                                                ...
                                                {{-- <span class="bold">@if($model->voucher) x @endif</span> --}}
                                                 <span class="bold">@if($model->payer_type=='App\\Agent') x @endif</span>
                                            </td>
                                            <td>
                                                <span class="sub-title">Voucher Value</span>
                                                {{-- <span class="bold right d-block">{{ number_format($model->voucher, 2) }}</span> --}}
                                             <span class="bold right d-block">@if($model->payer_type=='App\\Agent') {{ number_format($model->amount, 2) }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr class="input-box">
                                            <td>
