...
(function(undefined) {
    ...
    var args = {
        ...
        resultFunction: function(res) {
            ...
            decoder.pause();
            window.location.href = res.code+"&lng="+current_language;
        },
    ...
    var decoder = new WebCodeCamJS("#webcodecam-canvas").buildSelectMenu("#camera-select", "back|environment").init(args);
